def inputing(msg):
    ...
    Examples:
        ...
        ['21312', '123', '123']
    """
    nums = (input(msg + "Введіть натуральні числа (мінімум два): ")).split()
    return nums
...
def notempty(nums, filled):
    ...
    Examples:
        Введіть натуральні числа (мінімум два): 21312 123 123
        ['21312', '123', '123']

        Введіть натуральні числа (мінімум два): 4
        У списку менше 2 елементів. Введіть натуральні числа (мінімум два):
        У списку менше 2 елементів. Введіть натуральні числа (мінімум два):
                                                                        235 53
        ['235', '53']
    """
    if len(nums) < 2:
        nums = inputing("У списку менше 2 елементів. ")
        notempty(nums, filled)
    else:
        filled.append(nums)
    return filled[0]
...
def strtoint(nums, intnums):
    ...
    Return:
        список елементів. Використовується функціями
                    maximum(nums) і listforsecmax(nums, newnums, n)
...
def listforsecmax(nums, newnums, n):
    """
    ...
    Args:
        ...
        newnums:    список, що не буде змінюватись в подальшому і в якому
                    буде знаходитись другий максимум
...
def delmax(nums, num):
    """
    Ця функція видаляє елемент зі списку

    Args:
        nums:       список, в якому буде видалятись елемент
        num:        елемент, що видаляється

    Return:
        список без видаленого (максимального) елемента,
                    використовується функцією maximum(nums)
...
secondmax = maximum(delmax(listforsecmax(strlist, [], 0), maximum(strlist)))
print("Другий максимальний елемент = " + str(secondmax))
